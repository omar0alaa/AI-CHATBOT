...
def log_debug(message):
    # Log debug message
    chatbot_logger.debug(message)

def log_post_process(message):
    # Log PostProcess message
    chatbot_logger.PostProcess(message)

def log_info(message):
    # Log info message
    chatbot_logger.info(message)

def log_warning(message):
    # Log warning message
    chatbot_logger.warning(message)

def log_error(message):
    # Log error message
    chatbot_logger.error(message)

def setup_logger():
    # Setup logger - for backward compatibility
    return chatbot_logger.setup_logger()

def update_logger():
    # Update logger configuration
    chatbot_logger.update_logger()

def is_debug_enabled():
    # Check if debug mode is enabled
    return chatbot_logger.is_debug_enabled()
